...
export default function Home() {
  ...
  }, [selectedLeague, airportsMap, passengers, isRoundTrip, stats.emissionsGoal])
  ...
  }, [selectedLeague, airportsMap, passengers, isRoundTrip, searchQuery, currentPage, pageSize])
  ...
  }, [selectedLeague, airportsMap, passengers, isRoundTrip, fetchChartData])
  ...
  const StatsCard = ({ title, value, subtitle, icon, change = null, color = "emerald" }) => (
    <Card className={`overflow-hidden border-l-4 border-l-${color}-500`}>
        ...
        {isStatsLoading ? (
          ...
          <>
            <div className="flex items-baseline">
              ...
              {change !== null && (
                <div className={`ml-2 flex items-center text-sm ${change > 0 ? 'text-red-500' : 'text-emerald-500'}`}>
                  {change > 0 ? (
            ...
            {isChartLoading ? (
              ...
              <Card className="col-span-1">
                <CardHeader>
                  ...
                  <CardDescription>
                    CO2 emissions in tonnes for the {currentSeason} season
                  </CardDescription>
                </CardHeader>
                <CardContent className="h-80">
                  <BarChart 
