...
import type { Match, League, Season } from "@/lib/types"
...
export default function MatchesPage() {
  ...
  }, [selectedLeague, debouncedSearchQuery, selectedSeason])
  ...
  // Find current season name for display
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-8 text-center md:text-left">
          ...
          <p className="text-gray-400 mt-2 text-lg max-w-2xl mx-auto md:mx-0">
            Explore upcoming matches across all leagues for the {getCurrentSeasonName()} season
          </p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold text-xl mt-1">{getCurrentSeasonName()}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-800/40 backdrop-blur-sm border-gray-700 hover:border-emerald-600/50 transition-all duration-300 shadow-lg hover:shadow-emerald-700/10">
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-gray-400 text-sm">Available Seasons</p>
                  <p className="text-white font-semibold text-xl mt-1">{seasons.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                ...
                <Select value={selectedSeason} onValueChange={setSelectedSeason}>
                  <SelectTrigger className="w-full sm:w-[180px] border-gray-700 bg-gray-800/70 hover:bg-gray-800 text-gray-200">
        ...
        <Card className="bg-gray-900/90 backdrop-blur-sm border-gray-800 shadow-2xl overflow-hidden">
          <CardHeader className="border-b border-gray-800 bg-gray-900/80 backdrop-blur-sm py-4">
            <CardTitle className="text-xl text-white flex items-center">
              ...
              {selectedSeason ? `Matches for ${selectedSeason} Season` : "Select a Season"}
            </CardTitle>
          </CardHeader>
          <CardContent className="p-0">
            {!selectedSeason ? (
              <div className="p-16 text-center">
                <Calendar className="h-16 w-16 mx-auto text-emerald-700/50 mb-6" />
                <p className="text-gray-300 text-xl font-medium mb-2">
                  Please select a season to view matches
                </p>
                <p className="text-gray-500 max-w-md mx-auto">
                  Use the season selector above to choose which season's matches you want to view
                </p>
              </div>
            ) : isLoading ? (
        ...
        {/* Pagination Controls */}
        {selectedSeason && !isLoading && matches.length > 0 && (
